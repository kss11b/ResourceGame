  ...
  workerCollectionGenerator = () => {
    ...
    const menu = (
      <div className="col s12">
        <a className="waves-effect waves-light btn" onClick={this.mineGold}>
          Mine Gold
        </a>
        <a className="waves-effect waves-light btn" onClick={this.goFishing}>
          Go Fishing
        </a>
        <a className="waves-effect waves-light btn" onClick={this.bakeBread}>
          Bake Bread
        </a>
